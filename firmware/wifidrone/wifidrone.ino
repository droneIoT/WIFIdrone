...
void setup()
{
 // initialize the serial link with processing
  Serial.begin(115200);
  Serial.println("wifidrone ready...");
 // initialize the i2c bus  
  Wire.begin(4,5); // Configure i2c communication;
  Wire.setClock(400000); // Set i2c bus clock
//    pinMode(13, OUTPUT);
  WiFi.mode(WIFI_STA);
  delay(50);
  WiFi.disconnect();
...
//            Serial.print(AUX_1);Serial.print("\t"); 
            ...
            Serial.print("THR: ");
            Serial.print(CH_THR);Serial.print("\t");Serial.print("AIL: ");
            Serial.print(CH_AIL);Serial.print("\t");Serial.print("ELE: ");
            Serial.print(CH_ELE);Serial.print("\t");Serial.print("YAW: ");
            ...
            Serial.print("x: ");
            Serial.print(accel[XAXIS]);Serial.print("\t");Serial.print("y: ");
            Serial.print(accel[YAXIS]);Serial.print("\t");Serial.print("z: ");
